  ...
  return (
    <PromptInputHoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            "group relative flex h-8 cursor-default select-none items-center gap-1.5 rounded-full border border-border px-1.5 font-medium text-sm transition-all hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50",
            className
          )}
          key={data.id}
          {...props}
      ...
      <PromptInputHoverCardContent className="w-auto p-2">
        <div className="w-auto space-y-3">
          {isImage && (
            <div className="flex max-h-96 w-96 items-center justify-center overflow-hidden rounded-full border">
              <img
...
export const PromptInputSelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    className={cn(
      "border-none bg-transparent font-bold text-muted-foreground shadow-none transition-colors rounded-full",
      "hover:bg-transparent hover:text-muted-foreground aria-expanded:bg-transparent aria-expanded:text-muted-foreground focus:outline-none focus:ring-0 text-xs w-auto min-w-[40px] max-w-[60px]",
      className
    )}
    {...props}
  >
...
export type ModelCategory = "text" | "code" | "image" | "audio" | "video" | "multimodal";
